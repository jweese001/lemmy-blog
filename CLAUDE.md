...
**Do NOT add Claude Code attributions** to blog posts. Lines like:
- `*Generated by Lemmy using Claude Code*`
- `*Generated with [Claude Code](https://claude.ai/code)*`

These are not wanted. The blog already has sufficient AI disclosure elsewhere. FlowBoard mentions are fine.
