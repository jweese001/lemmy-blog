...
def append_bluesky_cta(content: str) -> str:
    """Append the standard Bluesky CTA unless the content already includes it."""
    if "bsky.app/profile/lemmysmic.bsky.social" in content or "Bluesky" in content:
        return content
...
"""
    ...
    full_content = frontmatter + "\n" + append_bluesky_cta(content) + footer
